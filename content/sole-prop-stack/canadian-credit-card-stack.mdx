...
![The three cards (Amex Cobalt, Scotiabank Momentum, Wealthsimple Visa Infinite Privilege) and three apps (Chexy, Rakuten, Great Canadian Rebates) that make up the Maple Cairn spending stack](/images/heroes/credit-card-stack-hero.webp)
...
![Wealthsimple Visa Infinite Privilege card](/images/cards/wealthsimple-privilege.webp)
...
![Rakuten Canada logo](/images/platform/rakuten.webp)

### Rakuten Canada: cashback portal for online shopping

Rakuten handles the everyday shopping: about 750 stores in the catalog including Old Navy, Sephora, Crocs, Oakley, Foot Locker, Aldo, HP, Lenovo, and Sony.

Click through Rakuten's portal before shopping, get a percentage of the purchase back as cashback, paid out quarterly as cash or gift card.

My lifetime cashback through Rakuten is $684.37. Most quarters I get $30-80 without thinking about it on purchases I would have made anyway. If you want in, [my referral link is here](https://www.rakuten.ca/r/maplecairn).

![Great Canadian Rebates logo](/images/platform/great-canadian-rebates.png)

### Great Canadian Rebates: the way I sign up for cards

GCR is the other cashback portal in my stack, and the one I lean on for opening cards. It overlaps with Rakuten on some stores and adds others, including travel bookings, but its real value is credit card sign-ups: it pays cashback on them. The Cobalt and Momentum links in this post route through GCR. Apply through those links and you get the card's welcome bonus and a GCR rebate, two separate payouts for one application. If you just want the portal without a card application, [sign up for GCR directly](https://www.greatcanadianrebates.ca/register/292741/).
...
This stack covers the basics: routing everyday spending through the right cards and stacking portals on top. More to come, things like business credit cards for the self-employed and optimizing for travel rewards instead of cashback.
